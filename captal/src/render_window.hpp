...
public:
    ...
    render_window(const std::u8string& title, const cpt::video_mode& mode, apr::window_options options = apr::window_options::none);
    render_window(const apr::monitor& monitor, const std::u8string& title, const cpt::video_mode& mode, apr::window_options options = apr::window_options::none);
