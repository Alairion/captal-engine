...
static entt::entity add_player(entt::registry& world, cpt::physical_world& physical_world)
{
    ...
    player_body->set_position({320.0f, 240.0f});
    ...
    auto& pivot{controller.attach_constraint(cpt::pivot_joint, *player_body, glm::vec2{}, glm::vec2{})};
...
static entt::entity fill_world(entt::registry& world, cpt::physical_world& physical_world)
{
    ...
    walls_body.attach_shape(glm::vec2{0.0f, 0.0f},   glm::vec2{0.0f, 480.0f}  ).set_collision_type(wall_type);
    walls_body.attach_shape(glm::vec2{0.0f, 0.0f},   glm::vec2{640.0f, 0.0f}  ).set_collision_type(wall_type);
    walls_body.attach_shape(glm::vec2{640.0f, 0.0f}, glm::vec2{640.0f, 480.0f}).set_collision_type(wall_type);
    walls_body.attach_shape(glm::vec2{0.0f, 480.0f}, glm::vec2{640.0f, 480.0f}).set_collision_type(wall_type);
