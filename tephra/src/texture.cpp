...
,m_depth{1}
{
    m_image = vulkan::image{underlying_cast<VkDevice>(renderer), VkExtent3D{width, 1, 1}, VK_IMAGE_TYPE_1D, static_cast<VkFormat>(m_format), static_cast<VkImageUsageFlags>(usage)};
...
,m_depth{1}
{
    m_image = vulkan::image{underlying_cast<VkDevice>(renderer), VkExtent3D{width, height, 1}, VK_IMAGE_TYPE_2D, static_cast<VkFormat>(m_format), static_cast<VkImageUsageFlags>(usage)};
    m_memory = renderer.allocator().allocate_bound(m_image, vulkan::memory_resource_type::non_linear, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
...
,m_depth{depth}
{
    m_image = vulkan::image{underlying_cast<VkDevice>(renderer), VkExtent3D{width, height, depth}, VK_IMAGE_TYPE_3D, static_cast<VkFormat>(m_format), static_cast<VkImageUsageFlags>(usage)};
    m_memory = renderer.allocator().allocate_bound(m_image, vulkan::memory_resource_type::non_linear, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
