...
if(NOT CAPTAL_SUPERBUILD_EXCLUDE_FREETYPE)
    ...
    list(APPEND ADDITIONAL_CMAKE_ARGS "-DFreetype_DIR=${CMAKE_BINARY_DIR}/dependencies/freetype/install/lib/cmake/freetype")
    list(APPEND ADDITIONAL_CMAKE_ARGS "-DCAPTAL_INTERNAL_FREETYPE=ON")
