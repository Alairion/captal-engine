...
option(CPT_SUPERBUILD_EXCLUDE_PORTAUDIO "Does not build PortAudio as a part of the superbuild, falling back on classic find_package." OFF)

if(NOT CPT_SUPERBUILD_EXCLUDE_PORTAUDIO)
    set(CPT_SUPERBUILD_PORTAUDIO_GIT_URL "https://github.com/PortAudio/portaudio.git" CACHE STRING "Used url for PortAudio git clone (allow usage of mirrors or interal repo)")
    set(CPT_SUPERBUILD_PORTAUDIO_GIT_TAG "v19.7.0" CACHE STRING "Used tag for PortAudio git clone")

    mark_as_advanced(CPT_SUPERBUILD_PORTAUDIO_GIT_URL)
    mark_as_advanced(CPT_SUPERBUILD_PORTAUDIO_GIT_TAG)

    ExternalProject_Add(PortAudio
        GIT_REPOSITORY ${CPT_SUPERBUILD_PORTAUDIO_GIT_URL}
        GIT_TAG        ${CPT_SUPERBUILD_PORTAUDIO_GIT_TAG}
        GIT_SHALLOW    TRUE
